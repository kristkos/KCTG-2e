...
Hooks.once('init', () => {
    game.settings.register('kctg-2e', 'show-warning', {
        name: 'Thank you!',
...
function setting(key) {
    return game.settings.get('kctg-2e', key);
}
...
Hooks.on("renderSettingsConfig", (app, html, data) => {
    ...
    warningParagraph.insertBefore($('[name="kctg-2e.show-warning"]').parents('div.form-group:first'));
});
